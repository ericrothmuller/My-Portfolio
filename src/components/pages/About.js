  ...
  return (
    <div className="aboutMe animate__animated animate__fadeIn backgroundImage">
      ...
      <div className="aboutImageDiv">
        <img
          className="aboutImage animate__animated animate__slideInRight"
      ...
      <p>
        ...
        experience, I have most recently worked as an IT professional and
        underwriter for a funeral funding company. In my more distant past
        (before I fell in love with web development), I was an animal control
        officer, professional gamer, and worked in mortgage.
      </p>
      &nbsp;
      <p>
        In my spare time, I enjoy spending time with my family and friends. My
        wife and I go swimming quite often with my step-daughter and niece. I am
        also a fairly competitive tennis player and enjoy getting on court. I
        also thoroughly enjoy continuing to learn programming and I dedicate a
        minimum of 2 hours a day learning new things and improving my craft.
      </p>
      &nbsp;
      <p>
        I am seeking a full-time permanent job that'll allow me to work as a web
        developer. I am willing to work in-office or remote and I am willing to
        relocate if needed. I am looking for a company that I could spend the
        rest of my professional life at.
      </p>
      <div>
        <div className="skillsButtons">
          <div className="columnDiv">
            <div id="leftDiv" className="leftDiv">
              <button className="developerSkillsButton" onClick={viewDevSkills}>
                Developer Skills
              </button>
            ...
            <div id="rightDiv" className="rightDiv">
              <button
                className="marketingSkillsButton"
                onClick={viewMarkSkills}
              >
                Marketing Skills
              </button>
